...
quadrantChart
    ...
    quadrant-1 "ทำก่อน (Major)"
    quadrant-2 "งานหลัก (Quick Wins)"
    ...
    SFX: [0.5, 0.5]
    bonus fruit: [0.6, 0.7]
    %%feature Art style ควรอยู่ใน MVP และ feature cutscene ควรตัดออกก่อนหากไม่มีเวลา
```
